      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-10 md:mb-16">
          {services.map((service, index) => (
            <div 
              key={index} 
              className="bg-card rounded-xl md:rounded-2xl p-5 md:p-6 shadow-card hover:shadow-elegant transition-all duration-300 group animate-scale-in border border-border/50 text-white h-full flex flex-col will-change-transform" 
              style={{
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
          ...
          <div 
            className="bg-card/50 rounded-xl p-5 md:p-6 border border-border/30 hover:border-primary/30 active:scale-[0.98] md:hover:scale-105 hover:shadow-lg active:bg-card/60 hover:bg-card/60 transition-all duration-300 cursor-pointer" 
            onClick={navigateToReality}
          >

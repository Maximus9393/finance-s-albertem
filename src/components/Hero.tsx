...
const Hero = () => {
  ...
  return <section className="min-h-screen flex items-center justify-center pt-16 md:pt-20">
      <div className="container mx-auto px-4 py-8 md:py-16">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-5 md:space-y-8 animate-fade-in order-2 lg:order-1">
            ...
            <p className="text-base md:text-xl text-muted-foreground leading-relaxed text-center lg:text-left">Albert Gurdžjan - váš osobní finanční poradce. Komplexní analýza a optimalizace rodinných financí pod záštitou společnosti 4fin Better Together a.s.</p>

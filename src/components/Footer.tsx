        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3">
              <li><a href="/pojisteni-liberec" className="text-background/80 hover:text-primary transition-colors text-sm md:text-base">Pojištění</a></li>
              <li><a href="/investice-liberec" className="text-background/80 hover:text-primary transition-colors text-sm md:text-base">Investice</a></li>
              <li><a href="/hypoteky-liberec" className="text-background/80 hover:text-primary transition-colors text-sm md:text-base">Hypotéky</a></li>

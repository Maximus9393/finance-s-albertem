      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-10 md:mb-16 w-full animate-scale-in">
          <div className="flex justify-center overflow-hidden">
            <img src="/cara_kontakt2.png" alt="Naše hodnoty - partnerství, inovace, kvalita, růst" className="max-w-none w-full max-w-6xl h-auto rounded-lg shadow-soft" loading="lazy" decoding="async" width="1368" height="37" sizes="(max-width: 1200px) 100vw, 1200px" onError={e => {
